...
nv.models.historicalBar = function() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            bars = wrap.select('.nv-bars').selectAll('.nv-bar')
...
nv.models.linePlusBarChart = function() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            // Setup Scales
            var dataBars = data.filter(function(d) { return !d.bar });
            var dataLines = data.filter(function(d) { return !d.bar }); // removed the !d.disabled clause here to fix Issue #240
            var dataStacked = data.filter(function(d) { return !d.bar }); // removed the !d.disabled clause here to fix Issue #240
    ...
    lines.dispatch.on('elementMouseover.tooltip', function(evt) {
        tooltip
            .duration(100)
            .valueFormatter(function(d, i) {
                return getAxisTest().main.tickFormat()(d, i);
            })
            .data(evt)
            .hidden(false);
    });
